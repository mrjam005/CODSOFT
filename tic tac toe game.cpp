...
int main(){
    ...
    char game;
    cout<<"press Y key to start the game or Q to quit"<<endl;
    cin>>game;
    ...
    while (game!='q')
    {
        ...
        {
            int move;
            cout<<"Player 1 turn..(Select the No. from Box to Play your Move)..."<<endl;
            ...
            cout<<"Player 2 turn..(Select the No. from Box to Play your Move"<<endl;
            cout<<"enter move: ";cin>>move;
